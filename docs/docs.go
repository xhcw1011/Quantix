...
const docTemplate = `{
    ...
    "paths": {
                ...
                "responses": {
                    "200": {
                        ...
                        "schema": {
                            "type": "array",
                            "items": {
                                "$ref": "#/definitions/api.EngineInfo"
                            }
                        }
                    },
                    "403": {
        ...
        "/api/admin/engines/{user_id}/{engine_id}": {
            "delete": {
                "security": [
                    {
                        "BearerAuth": []
                ...
                "parameters": [
                    {
                        ...
                        "required": true,
                        "schema": {
                            "$ref": "#/definitions/api.backtestReq"
                        }
                    }
                ],
                "responses": {
        ...
        "/api/backtest/{id}": {
            "get": {
                ...
                "parameters": [
                    {
                        "type": "string",
                        "description": "Backtest job ID (UUID)",
                        "name": "id",
                        "in": "path",
                        "required": true
                    }
                ...
                "responses": {
                    "200": {
                        ...
                        "schema": {
                            "type": "array",
                            "items": {
                                "$ref": "#/definitions/api.credentialResp"
                            }
                        }
                    },
                    "500": {
                ...
                "parameters": [
                    {
                        ...
                        "required": true,
                        "schema": {
                            "$ref": "#/definitions/api.credentialReq"
                        }
                    }
                ],
                "responses": {
        ...
        "/api/credentials/{id}": {
            "put": {
                ...
                "parameters": [
                    ...
                    {
                        "description": "Updated credential fields",
                        "name": "body",
                        "in": "body",
                        "required": true,
                        "schema": {
        ...
        "/api/engines": {
            ...
            "post": {
                ...
                "parameters": [
                    {
                        "description": "Engine start parameters",
                        "name": "body",
                        "in": "body",
                        "required": true,
                        "schema": {
                            "$ref": "#/definitions/api.StartRequest"
                        }
                    }
                ],
                "responses": {
        ...
        "/api/fills": {
            "get": {
                ...
                "parameters": [
                    ...
                    {
                        "type": "string",
                        "description": "Filter by mode (live|paper)",
                        "name": "mode",
                        "in": "query"
                    },
                    {
    ...
    "definitions": {
        "api.EngineInfo": {
            ...
            "properties": {
                ...
                "user_id": {
                    "description": "populated in admin views",
                    "type": "integer"
                }
            }
        },
        ...
        "api.StartRequest": {
            ...
            "properties": {
                "contract_mode": {
                    "description": "\"hedge\" | \"one_way\" (futures/swap only)",
                    "type": "string"
                },
                "credential_id": {
                    "type": "integer"
                ...
                "leverage": {
                    "description": "1–20; 0 = use exchange default (futures/swap only)",
                    "type": "integer"
                },
                "mode": {
                    "description": "\"live\" (default) | \"paper\"",
                    "type": "string"
                },
                "paper": {
                    "description": "required when mode=paper",
                    "allOf": [
                        {
                            "$ref": "#/definitions/api.PaperConfig"
                        }
                    ]
                },
                "params": {
                    "description": "extra strategy parameters",
                    "type": "object",
                    "additionalProperties": {}
                },
                "risk": {
                    "$ref": "#/definitions/api.RiskOverride"
                },
                "strategy_id": {
                    "type": "string"
                },
