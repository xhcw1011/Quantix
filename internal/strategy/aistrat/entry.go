...
func (s *AIStrategy) placeOrder(ctx *strategy.Context, side string, price, qty float64, useLimit bool, stopLoss float64) string {
	return s.placeOrderEx(ctx, side, price, qty, useLimit, false, stopLoss)
}
...
func (s *AIStrategy) placeOrderEx(ctx *strategy.Context, side string, price, qty float64, useLimit, makerOnly bool, stopLoss float64) string {
